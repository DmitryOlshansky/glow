...
export class SignalingChannel {
     ...
     * @param {String} login - identifies room to join
     * @param {String} secret - preshared secret to enter the `login` room
    ...
    resetListeners() {
        ...
        this.onMessage = (message) => (this.verbose ? console.log( JSON.stringify(message)) : "");
